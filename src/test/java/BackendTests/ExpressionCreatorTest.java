...
public class ExpressionCreatorTest {
    ...
    Axes axes = new Axes();
    RealBooleanCreatorImp realBooleanCreatorImp;
    ...
    public void testSingleNumber() throws InvalidTermException {
        RealValuedExpression exp = (RealValuedExpression) realBooleanCreatorImp.create(List.of("2"));
        assertEquals(2.0, exp.evaluate(varMap), delta);
    }

    @Test(timeout = 50)
    public void testSingleVariable() throws InvalidTermException {
        RealValuedExpression exp = (RealValuedExpression) realBooleanCreatorImp.create(List.of("x"));
        varMap.put("x", 5.0f);
    ...
    public void testBinaryOperatorTwoTerms() throws InvalidTermException {
        RealValuedExpression exp = (RealValuedExpression) realBooleanCreatorImp.create(List.of("2", "+", "3"));
        assertEquals(5.0, exp.evaluate(varMap), delta);
    }
    ...
    public void testBinaryOperatorWithOneVariable() throws InvalidTermException {
        RealValuedExpression exp = (RealValuedExpression) realBooleanCreatorImp.create(List.of("x", "/", "3"));
        varMap.put("x", 3.0f);
    ...
    public void testBinaryOperatorWithTwoVariables() throws InvalidTermException {
        RealValuedExpression exp = (RealValuedExpression) realBooleanCreatorImp.create(List.of("x", "/", "y"));
        varMap.put("x", 3.0f);
        varMap.put("y", 6.0f);
    ...
    public void testOrderOfOperations1() throws InvalidTermException {
        RealValuedExpression exp = (RealValuedExpression) realBooleanCreatorImp.create(List.of("1.5", "+", "3", "*", "5"));
        assertEquals(16.5, exp.evaluate(varMap), delta);
    }

    @Test(timeout = 50)
    public void testOrderOfOperations2() throws InvalidTermException {
        RealValuedExpression exp = (RealValuedExpression) realBooleanCreatorImp.create(List.of("4", "*", "3", "-", "2"));
        assertEquals(10.0, exp.evaluate(varMap), delta);
    }

    @Test(timeout = 50)
    public void testOrderOfOperations3() throws InvalidTermException {
        RealValuedExpression exp = (RealValuedExpression) realBooleanCreatorImp.create(List.of("x", "*", "3", "-", "2"));
        varMap.put("x", 4.0f);
        assertEquals(10.0, exp.evaluate(varMap), delta);
    }
    ...
    public void testRepeatedOperations() throws InvalidTermException {
        RealValuedExpression exp = (RealValuedExpression) realBooleanCreatorImp.create(List.of("2", "-", "1", "-", "3"));
        assertEquals(-2, exp.evaluate(varMap), delta);
    }

    @Test(timeout = 50)
    public void testRepeatedOperations2() throws InvalidTermException {
        RealValuedExpression exp = (RealValuedExpression) realBooleanCreatorImp.create(List.of("2", "/", "4", "/", "10"));
    ...
    public void testPower() throws InvalidTermException {
        RealValuedExpression exp = (RealValuedExpression) realBooleanCreatorImp.create(List.of("x", "^", "2"));
        varMap.put("x", 4.f);
    ...
    public void testCos() throws InvalidTermException {
        RealValuedExpression exp = (RealValuedExpression) realBooleanCreatorImp.create(List.of("cos", "(", "x",
                "^", "2", ")"));
        varMap.put("x", 1.f);
    ...
    public void testCosWithOtherOperators() throws InvalidTermException {
        RealValuedExpression exp = (RealValuedExpression) realBooleanCreatorImp.create(List.of("2", "*", "cos", "(", "x",
                "^", "2", ")", "+", "5"));
        varMap.put("x", 0.f);
    ...
    public void testSin() throws InvalidTermException {
        RealValuedExpression exp = (RealValuedExpression) realBooleanCreatorImp.create(List.of("sin", "(", "x",
                "^", "2", ")"));
        varMap.put("x", 1.f);
    ...
    public void testTan() throws InvalidTermException {
        RealValuedExpression exp = (RealValuedExpression) realBooleanCreatorImp.create(List.of("tan", "(", "x",
                "^", "2", ")"));
        varMap.put("x", 1.f);
    ...
    public void testLessThanOrEqualTo() throws InvalidTermException {
        BooleanValuedExpression exp = (BooleanValuedExpression) realBooleanCreatorImp.create(List.of("x", "<=", "5"));
        varMap.put("x", 4.9f);
    ...
    public void testLessThanOrEqualToWithOtherOperators() throws InvalidTermException {
        BooleanValuedExpression exp = (BooleanValuedExpression) realBooleanCreatorImp.create(List.of("x", "+", "z",
                "<=", "5", "-", "y"));
        varMap.put("x", 5.0f);
        varMap.put("y", 0.1f);
        varMap.put("z", 0.0f);
    ...
    public void testMultipleComparators() throws InvalidTermException {
        ...
        BooleanValuedExpression exp = (BooleanValuedExpression) realBooleanCreatorImp.create(List.of("0", "<", "x",
                "<=", "y", "<=", "1"));
        varMap.put("x", 0.0f);
        varMap.put("y", 0.9f);
        assertEquals(false, exp.evaluate(varMap));
    ...
    public void testLogicalOperatorWithOtherOperators() throws InvalidTermException {
        // currently fails
        BooleanValuedExpression exp = (BooleanValuedExpression) realBooleanCreatorImp.create(List.of("1", "<", "x", "&",
                "x", "<=", "4", "+", "1"));
        varMap.put("x", 1.0f);
        assertEquals(false, exp.evaluate(varMap));
        varMap.put("x", 2.0f);
    ...
    public void testSqrtDomain() throws InvalidTermException {
        RealValuedExpression exp = (RealValuedExpression) realBooleanCreatorImp.create(List.of("sqrt", "(", "x", ")"));
        varMap.put("x", -1.f);
    ...
    public void testCustomFunctions() throws InvalidTermException {
        String funcName = "f";
        String[] variables = {"x"};
        RealValuedExpression func = (RealValuedExpression) realBooleanCreatorImp.create(List.of("x", "^", "2"));
    ...
    public void testCustomFunctionDomain() throws InvalidTermException {
        ...
        ComparatorExpression domain = (ComparatorExpression) realBooleanCreatorImp.create(List.of("x", ">", "0"));
    ...
    public void testCustomFunctionMultivariable() throws InvalidTermException {
        ...
        RealValuedExpression func = (RealValuedExpression) realBooleanCreatorImp.create(List.of("x", "/", "y"));
        RealValuedExpression myFunc = new CustomFunctionExpression(funcName, variables, func);
    ...
    public void testExp() throws InvalidTermException {
        RealValuedExpression exp = (RealValuedExpression) realBooleanCreatorImp.create(List.of("exp", "(", "x",
                "^", "2", ")"));
        varMap.put("x", 1.f);
    ...
    public void testArcsin() throws InvalidTermException {
        RealValuedExpression exp = (RealValuedExpression) realBooleanCreatorImp.create(List.of("arcsin", "(", "x",
                "^", "2", ")"));
        varMap.put("x", 1.f);
    ...
    public void testArccos() throws InvalidTermException {
        RealValuedExpression exp = (RealValuedExpression) realBooleanCreatorImp.create(List.of("arccos", "(", "x",
                "^", "2", ")"));
        varMap.put("x", 1.f);
    ...
    public void testArctan() throws InvalidTermException {
        RealValuedExpression exp = (RealValuedExpression) realBooleanCreatorImp.create(List.of("arctan", "(", "x",
                "^", "2", ")"));
        varMap.put("x", 1.f);
    ...
    public void testLogarithm() throws InvalidTermException {
        RealValuedExpression exp = (RealValuedExpression) realBooleanCreatorImp.create(List.of("log", "(", "x",
                "^", "2", ")"));
        varMap.put("x", 1.f);
