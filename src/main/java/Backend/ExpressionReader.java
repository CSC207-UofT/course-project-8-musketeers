...
public class ExpressionReader {
    ...
    // e.g. (2) + 3 or 3 + (2) -> ["(", "2", ")", "+", "3"]
    // e.g. cos(x) -> ["cos", "(", "x", ")"]
    public Expression read(String expression) throws BaseCaseCreatorException, CompoundCaseCreatorException, NonCreatorException {
        ...
        if (equalsIndex > 0) {
            // TODO: Below added by Ted (the static checker before creating expressions):
            List<String> subExpression = expressionList.subList(equalsIndex + 1, expressionList.size());
            ec.staticCheck(subExpression);
            // Above added by Ted.
            return ec.create(subExpression);
        }
        else{
            ec.staticCheck(expressionList);
...
// TODO: Below old main function, perhaps useful!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
////        map.g
////        System.out.println(func.evaluate(map)); //
////        axes.addExpression(func);
//
